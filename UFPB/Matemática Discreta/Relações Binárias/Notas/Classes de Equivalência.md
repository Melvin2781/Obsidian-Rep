...
## Notação:
Seja n um inteiro positivo e a relação de equivalência ≡ (mod n). O conjunto quociente é denotado por: Zn = Z/≡ (mod n). Ou seja, Z2 = Z/≡ (mod 2) = {[1], [0]}. Isso acontece, pois as outras classes de equivalência, ou são iguais ao [1] ou são iguais ao [0], pois eles possuem ao menos um elemento em comum com eles. Dessa forma podemos representar o <mark style="background: #FF5582A6;">conjunto quociente</mark> desse conjunto como: {[0], [1]}.